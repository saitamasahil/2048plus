...
- **Store & Customization**: Integrated Store and 40 custom themes & items.
- **Achievements & Visuals**: 33 unlockable achievements, embedded lo-fi BGM playlist, procedural SFX, and CRT shader.
...
- Adorable Animal Sprites by: [Elthen](https://elthen.itch.io/)
